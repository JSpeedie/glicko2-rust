...
///     in Step 6.
pub fn update_rd(phi: f64, sigma: f64) -> f64 {
...
/// and RDs. This function constitutes Step 7 of the Glicko-2 algorithm.
///
/// Parameters:
...
/// Return:
/// * Nothing - the function modifies the `G2Player` struct.
pub fn update_player(player: &mut G2Player, opp_ratings: &f64, opp_rds: &f64,
                 scores: &f32) {
